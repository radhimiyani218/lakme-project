...
const display = (data) => {
    data.map((products) => {
        ...
        btn.addEventListener("click",()=>{
            id= products.id;
            console.log(id);
             fetch(`http://localhost:3000/skin/${id}`)
                 .then((res)=>res.json())
                 .then((data)=>{
                     console.log(data)
...
document.getElementById("SKINCARE").addEventListener("click",()=>handelcategory("SKINCARE"));
document.getElementById("MAKEUP").addEventListener("click",()=>handelcategory("MAKEUP"));
document.getElementById("SERUMS").addEventListener("click",()=>handelcategory("SERUMS"));
