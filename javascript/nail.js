...
const display = (data) => {
    data.map((products) => {
        ...
        document.getElementById("nail").append(div)
    })
}
const get = () => {
...
const handlelth = () => {
    document.getElementById("nail").innerHTML = ""
...
document.getElementById("POLISH REMOVER").addEventListener("click",()=>handelcategory("POLISH REMOVER"));
document.getElementById("NAIL COLOR").addEventListener("click",()=>handelcategory("NAIL COLOR"));
